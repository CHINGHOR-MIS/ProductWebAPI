package com.setec.product_web_api.Controller;
...
import com.setec.product_web_api.DAO.PostProductDAO;
import com.setec.product_web_api.DAO.PutProductDAO;
import com.setec.product_web_api.Entity.Product;
import com.setec.product_web_api.Repos.ProductRepos;;
...
public class MyController {
	...
	public Object putProduct(@ModelAttribute PutProductDAO product) throws Exception{
		...
		if(p.isPresent()) {
			...
			return ResponseEntity.status(HttpStatus.ACCEPTED)
					.body(Map.of("message", "product id = " + id + " has been updated successfully", "product", update));
		}
